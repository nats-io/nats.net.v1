...
namespace NATSExamples
{
    ...
    /// </summary>
    internal static class JetStreamPushSubscribeBindDurable
    {
        private const string Usage =
            "Usage: JetStreamPushSubscribeBindDurable [-url url] [-creds file] [-stream stream] [-subject subject] [-count count] [-durable durable] [-deliver deliverSubject]" +
            "\n\nDefault Values:" +
            "\n   [-stream]  example-stream" +
            "\n   [-subject] example-subject" +
            "\n   [-deliver] bind-deliver" +
            "\n   [-durable] bind-durable" +
            "\n   [-count]   0" +
            "\n\nRun Notes:" +
